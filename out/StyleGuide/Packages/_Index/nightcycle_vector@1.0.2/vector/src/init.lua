...
export type Vector = {
	...
	Magnitude: number,
	Type: string,
	__add: ((self: Vector, other: Vector) -> Vector) & ((self: Vector, other: number) -> Vector),
	__sub: ((self: Vector, other: Vector) -> Vector) & ((self: Vector, other: number) -> Vector),
	__mul: ((self: Vector, other: Vector) -> Vector) & ((self: Vector, other: number) -> Vector),
	__div: ((self: Vector, other: Vector) -> Vector) & ((self: Vector, other: number) -> Vector),
	__pow: ((self: Vector, other: Vector) -> Vector) & ((self: Vector, other: number) -> Vector),
	__mod: ((self: Vector, other: Vector) -> Vector) & ((self: Vector, other: number) -> Vector),
	__eq: (self: Vector, other: any?) -> boolean,
	__tostring: (self: Vector) -> string,
	ToScalars: (self: Vector) -> { [number]: number },
	Round: (self: Vector, power: number?) -> Vector,
	Floor: (self: Vector, power: number?) -> Vector,
	Ceil: (self: Vector, power: number?) -> Vector,
	Cross: (self: Vector, other: Vector) -> Vector,
	DotProduct: (self: Vector, other: Vector) -> Vector,
	Dot: (self: Vector, other: Vector) -> number,
	Lerp: (self: Vector, other: Vector, alpha: number) -> Vector,
	ToVector3: (self: Vector) -> Vector3,
	ToVector2: (self: Vector) -> Vector2,
	zero: (size: number) -> Vector,
	fromVector3: (val: Vector3) -> Vector,
	fromVector2: (val: Vector2) -> Vector,
	one: (size: number) -> Vector,
	identity: (size: number, index: number) -> Vector,
	new: (...number) -> Vector,
	[number]: number,
}
